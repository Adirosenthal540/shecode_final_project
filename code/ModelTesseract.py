...
class ModelTesseract:
    ...
    def ExportTextTesseract(self, image):
        str = pytesseract.image_to_string(image, lang="heb")
        return str
...
# # wImg= img.shape[1]
# # hImg= img.shape[0]
# # boxes = pytesseract.image_to_data((dilation))
# # print (boxes)
...
# # # print (str)
# # boxes= pytesseract.image_to_boxes(dilation)
# # print(boxes)
# # for b in boxes.splitlines():
# #     print(b)
# #     b=b.split(" ")
# #     x,y,w,h = int(b[1]),int(b[2]), int(b[3]),int(b[4])
# #     cv2.rectangle(img, (x,hImg-y), (w,hImg -h), (0,255,0), 5)
